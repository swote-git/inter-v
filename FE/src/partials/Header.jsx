    ...
    <header className="absolute w-full z-30">
      <div className="w-[85%] mx-auto px-4 sm:px-6">
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="text-2xl font-bold px-3" >INTERV</div>
          ...
          <nav className="hidden md:flex md:grow">
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              <li className="px-4">모의 면접</li>
              <li className="px-4">나의 이력서</li>
              <li className="px-4">마이페이지</li>

              <li>
                <Link to="/signin" className="font-medium text-purple-600 hover:text-gray-200 px-4 py-3 flex items-center transition duration-150 ease-in-out">로그인</Link>
              </li>
              <li>
                <Link to="/signup" className="btn-sm text-white bg-purple-600 hover:bg-purple-700 ml-3">회원가입</Link>
              </li>
            </ul>
          </nav>
